...
extension ImageResource {
    ...
    static let artOfTheJourney1 = ImageResource(name: "Art of the Journey 1", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "Art of the Journey 1" asset catalog image.
    static var artOfTheJourney1: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .artOfTheJourney1)
#else
        .init()
#endif
    }

    /// The "PMR Logo" asset catalog image.
    static var pmrLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
...
extension UIKit.UIImage {
    ...
    /// The "Art of the Journey 1" asset catalog image.
    static var artOfTheJourney1: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .artOfTheJourney1)
#else
        .init()
