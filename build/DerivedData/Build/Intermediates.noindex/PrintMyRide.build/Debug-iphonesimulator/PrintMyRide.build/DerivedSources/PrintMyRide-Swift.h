...
#ifndef PRINTMYRIDE_SWIFT_H
#define PRINTMYRIDE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PrintMyRide",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC11PrintMyRide12AccountStore")
...
@class NSXMLParser;
@class NSString;
SWIFT_CLASS("_TtC11PrintMyRide11GPXImporter")
@interface GPXImporter : NSObject <NSXMLParserDelegate>
...
SWIFT_CLASS("_TtC11PrintMyRide11StravaOAuth")
@interface StravaOAuth : NSObject <ASWebAuthenticationPresentationContextProviding>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
