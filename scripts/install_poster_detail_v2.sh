...
ROOT="$(pwd)"
mkdir -p "$ROOT/PrintMyRide/Utilities" "$ROOT/PrintMyRide/UI"

# 1) AutoWriter (fire and forget)
cat > "$ROOT/PrintMyRide/Utilities/AutoWriter.swift" <<'SWIFT'
...
# 2) Poster Detail V2
cat > "$ROOT/PrintMyRide/UI/PosterDetailV2.swift" <<'SWIFT'
...
echo " - PrintMyRide/Utilities/AutoWriter.swift"
echo " - PrintMyRide/UI/PosterDetailV2.swift"